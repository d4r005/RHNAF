        ...
        transaction(database) {
            ...
            if (!rawDatabaseUrl.isNullOrBlank()) {
                val publicTablesRequiringRls = listOf(
                    ...
                    "ehs_action_plans", "ehs_contractors", "ehs_rate_periods", "ehs_chemical_inventory", "ehs_documents", "ehs_emergency_drills",
                    "ehs_environmental_waste", "ehs_legal_matrix", "ehs_occupational_health",
                    "ehs_ppe_deliveries", "ehs_risk_matrix", "ehs_safety_incidents",
                    "ehs_safety_inspections", "ehs_safety_trainings", "ehs_work_permits", "ehs_dc3_constancias", "ehs_custom_events",
